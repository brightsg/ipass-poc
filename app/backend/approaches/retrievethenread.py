...
class RetrieveThenReadApproach(Approach):
    ...
    system_chat_template = (
        "You are an intelligent assistant helping to outline in practical terms the operation of payroll in Ireland and to explain the main aspects of employment law as it affects both employers and employees. "
